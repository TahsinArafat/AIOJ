...
export default function EditorialDetail() {
    ...
    if (!editorial) return <div className="text-center py-20 text-gray-400">Editorial not found</div>
        ...
        <div className="max-w-3xl mx-auto">
            <article className="mb-8">
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500 mb-6">
                    <span className="font-semibold text-gray-700">{editorial.username}</span>
                ...
                {editorial.approach && (
                    <div className="mb-4 p-3 bg-blue-50 rounded-lg">
                        <span className="text-xs font-semibold text-blue-700 uppercase tracking-wide">Approach:</span>
                        <p className="mt-1 text-sm text-blue-800">{editorial.approach}</p>
                    </div>
                )}

                <div className="prose max-w-none text-gray-800 mb-8">{editorial.content}</div>
                    ...
                    <div className="flex gap-6 mb-8">
                        {editorial.time_complexity && (
                            <div className="bg-gray-50 px-4 py-2 rounded-lg">
                                ...
                                <span className="ml-2 font-mono font-semibold text-gray-700">{editorial.time_complexity}</span>
                            </div>
                        )}
                        {editorial.space_complexity && (
                            <div className="bg-gray-50 px-4 py-2 rounded-lg">
                                <span className="text-xs text-gray-500 uppercase tracking-wide">Space:</span>
                                <span className="ml-2 font-mono font-semibold text-gray-700">{editorial.space_complexity}</span>
                            </div>
                        )}
                    </div>
                )}
