...
export default function StatementTab({
  ...
  return (
    <form onSubmit={onSave} className="space-y-4">
      <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 border-b pb-2 mb-4">Edit Problem Statement</h2>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full border border-gray-300 dark:border-gray-600 rounded px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200"
            required
          />
        </div>
        <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase mb-1">Time Limit (ms)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase mb-1">Memory Limit (KB)</label>
          <input
            type="number"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Description (Markdown + LaTeX)</label>
              <input
                type="file"
                ref={imageInputRef}
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 disabled:opacity-50 transition-colors cursor-pointer"
              >
        ...
        <div>
          <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase mb-1">Live Preview</label>
          <div className="prose prose-sm max-w-none bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 max-h-[600px] overflow-y-auto">
            {formState.description || formState.inputFormat || formState.outputFormat || formState.hint ? (
              ...
              <p className="text-gray-400 dark:text-gray-500 text-sm italic">Start typing to see a live preview of your problem statement with rendered Markdown and LaTeX math formulas.</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="font-semibold text-sm text-gray-700 dark:text-gray-300">Sample Cases</h3>
          <button
            type="button"
        ...
        {formState.sampleCases.map((sc, i) => (
          <div key={i} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-3 bg-white dark:bg-gray-800">
            <div className="flex items-center justify-between">
              <span className="font-medium text-sm text-gray-800 dark:text-gray-200">Sample {i + 1}</span>
              <button
                type="button"
                onClick={() => onUpdate('sampleCases', formState.sampleCases.filter((_, j) => j !== i))}
                className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 text-xs cursor-pointer"
              >
                Remove
              </button>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full font-mono text-xs border border-gray-300 dark:border-gray-600 rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-800"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full text-sm border border-gray-300 dark:border-gray-600 rounded px-2 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 bg-white dark:bg-gray-800"
              />
            </div>
          </div>
        ))}
