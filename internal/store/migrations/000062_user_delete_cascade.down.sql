-- Reverse 000062: restore non-cascade (NO ACTION) FKs and NOT NULL authors.
...
UPDATE problems SET created_by = created_by WHERE created_by IS NULL;
...
ALTER TABLE contests ADD CONSTRAINT contests_created_by_fkey
    FOREIGN KEY (created_by) REFERENCES users(id);
ALTER TABLE contests ALTER COLUMN created_by SET NOT NULL;
...
ALTER TABLE gym_contests ADD CONSTRAINT gym_contests_created_by_fkey
    FOREIGN KEY (created_by) REFERENCES users(id);
ALTER TABLE gym_contests ALTER COLUMN created_by SET NOT NULL;
...
ALTER TABLE contest_notices ADD CONSTRAINT contest_notices_created_by_fkey
    FOREIGN KEY (created_by) REFERENCES users(id);
ALTER TABLE contest_notices ALTER COLUMN created_by SET NOT NULL;
